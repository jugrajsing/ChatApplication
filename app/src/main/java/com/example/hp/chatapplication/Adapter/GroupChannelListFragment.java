...
public class GroupChannelListFragment extends Fragment {
    ...
    void enterGroupChannel(String channelUrl) {
       /* GroupChatFragment fragment = GroupChatFragment.newInstance(channelUrl);getChildFragmentManager().beginTransaction()
                .replace(R.id.container_group_channel, fragment)
                .addToBackStack(null)
                .commit();*/

        //    Bundle gameData = new Bundle();
        //    gameData.putString("URL",channelUrl);
    ...
    private void refreshChannelList(int numChannels) {
       /* mChannelListQuery = GroupChannel.createMyGroupChannelListQuery();
        ...
        userIds.add( sharedPrefsHelper.getQbUser().getId().toString());

        mChannelListQuery.setUserIdsIncludeFilter(userIds, GroupChannelListQuery.QueryType.AND);*/
        mChannelListQuery = GroupChannel.createMyGroupChannelListQuery();
        mChannelListQuery.setLimit(numChannels);
